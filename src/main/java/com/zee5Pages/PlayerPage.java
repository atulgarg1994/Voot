...
public class PlayerPage {
	...
	public static By objPlayerMinimizeIcon = By
			.xpath("//*[@id='player_minimize_button']");
	...
	public static By objPlayerThreeDotsIcon = By
			.xpath("//*[@id='player_options_button']");
	...
	public static By objtvShowMetadata = By
			.xpath("//*[@id='tvshow_season_episodes_text']");

	public static By objPlayerWatchLaterBtn = By
			.xpath("//*[@id='player_options_watch_later']");
	...
	public static By objPlayerAudioLanguage = By
			.xpath("//*[@id='tvshows_audio_lang_text']");

	public static By objPlayerAudioLanguageText = By
			.xpath("//*[@id='tvshows_audio_lang_input']");

	public static By objPlayerCollapseIcon = By.xpath("//*[@id='expand_collapse_icon']");

	public static By objPlayerDescription = By
			.xpath("//*[@id='tvshow_overview_detail_text']");
	...
	// Subtitle/CC
	public static By objSubtitlePopupText = By
			.xpath("//*[@id='player_dialog_head_text']");
	...
	// Audio Language
	public static By objAudioLanguagePopupText = By
			.xpath("//*[@id='player_dialog_head_text']");

	public static By objAudioLanguagePopuoOption = By
			.xpath("//*[@id='dialog_radio_button']");

	public static By objAudioLanguagePopuoOptions(int value) {
		return By.xpath("(//*[@id='dialog_radio_button'])[" + value + "]");
	}

	public static By objAudioLanguageOKbtn = By
			.xpath("//*[@id='player_dialog_ok_text']");
	...
	public static By objWatchlistcount = By
			.xpath("//*[@id='profile_fragment_page_title']");
	...
	public static By objProfileScreenBackbutton = By
			.xpath("//*[@id='profile_screen_back_button']");
