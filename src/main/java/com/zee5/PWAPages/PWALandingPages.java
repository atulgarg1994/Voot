...
public class PWALandingPages {
	...
	public static By obj_Pwa_Trending_On_Zee5 = By.xpath("//*[text()='Trending on ZEE5']");
	
	public static By obj_Pwa_PlayIcon_Carousal = By.xpath("(//*[@nodeName='DIV' and ./parent::*[@nodeName='DIV' and ./parent::*[@nodeName='DIV'] and (./preceding-sibling::* | ./following-sibling::*)[@text=' Previous']]]/*/*/*/*/*/*/*[@nodeName='DIV' and @width>0 and ./parent::*[@nodeName='DIV' and @width>0 and (./preceding-sibling::* | ./following-sibling::*)[@text='Get premium'] and ./parent::*[@nodeName='DIV' and @width>0 and (./preceding-sibling::* | ./following-sibling::*)[./*[@text='Seetharama Kalyana']]]]])[1]");
	
	public static By obj_Pwa_Content_Rail_View_all = By.xpath("//*[@nodeName='DIV' and @width>0 and ./parent::*[@nodeName='DIV' and @width>0] and (./preceding-sibling::* | ./following-sibling::*)[@nodeName='H2' and ./*[@text='Top ZEE5 Movies in Kannada']]]");
	...
	public static By objtrayTitle(String trayTitleFromAPI) {
		return By.xpath("//div[@class='trayHeader']/h2/a[@class='titleLink' and contains(text(),'"+trayTitleFromAPI+"')]");
	}
	
	public static By objtrayFirstContent(String trayTitleFromAPI, String trayFirstContentFromAPI) {
		return By.xpath("//*[@class='titleLink' and contains(text(),'"+trayTitleFromAPI+"')]/following::div[contains(@data-minutelytitle,'"+trayFirstContentFromAPI+"') and contains(@class,'content')]");
	}
	
	public static By objViewAllOfTray(String trayTitle) {
		return By.xpath("//*[@class='titleLink' and contains(text(),'"+trayTitle+"')]//parent::*//following-sibling::*[@class='arrow iconInitialLoad-ic_viewall noSelect']");
	}
...
//	TANISHA RECO MODULE
	...
	public static By objFirstAssetInTray(String apiTrayTitle, String apiContentTitle) {
		return By.xpath("//h2[text()=\"" + apiTrayTitle+ "\"]//parent::div//following-sibling::div//div[contains(@class,'slick-track')]//div[@data-index='0']//*[@data-minutelytitle=\""+ apiContentTitle + "\"]");
	}

	public static By objFirstAssetInTrayIndex(String trayTitleUI) {
		return By.xpath("//h2[contains(text(),\"" + trayTitleUI+ "\")]//parent::div//following-sibling::div//div[contains(@class,'slick-track')]//div[@data-index='0']//a");
	}
	...
	public static By objHindiInContentLanguageSelected = By.xpath("//*[@class='checkboxWrap checkedHighlight']//*[@for='content_hi']");
