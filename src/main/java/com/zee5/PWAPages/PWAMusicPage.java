...
//	Carousel title 
	public static By objCarouselTitle = By.xpath("//div[@class='slick-slide slick-active slick-current']//*[contains(@class,'legendTitle')]");
...
//	Selected Language in content language pop-Up
	public static By objContentLanguage = By.xpath("//div[@class='checkboxWrap checkedHighlight']//*[@class='innnerContentWrap']//*[@class='commonName']");
...
//	Premium tumbnail
	...
	{
		return By.xpath("((//div[@class='trayHeader']//h2[.='"+str+"'])//parent::*//parent::*//div[@class='noSelect clickWrapper' or @class='clickWrapper'])["+i+"]//div[@class='cardPremiumContent']");
	}
	
//	Video tumbnail
	public static By objVideoTumbnailTitle(String str,int i)
	{
		return By.xpath("(((//div[@class='trayHeader']//h2[.='"+str+"'])//parent::*//parent::*//div[@class='noSelect clickWrapper' or @class='clickWrapper'])["+i+"])//figure//img");
	}
...
//	Minimize window button
	...
	public static By objPremiumTagContentCard(String str) {
		return By.xpath("((//div[@class='clickWrapper'])//a//img[@title='"+str+"']//parent::*)//parent::*//div[@class='cardPremiumContent']");
	}
