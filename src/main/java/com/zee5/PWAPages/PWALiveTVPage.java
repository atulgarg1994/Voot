...
public class PWALiveTVPage {
	...
	public static By objChannelGuideFilterOption = By.xpath("(//div[@class=\"filterComponent  filterComponentFixedBottom\"])");
	
	public static By objLiveTvFilterOption = By.xpath("//*[contains(@class,'filterComponent  filterComponentFixedBottom')]");
	
	public static By objChannelGuideSortOption = By.xpath("(//button[@class='sortComponent iconInitialLoad-ic_sort '])");
	...
	public static By objUpcomingLiveProgramCloseBtn = By.xpath("//div[@class='noSelect closePupup iconInitialLoad-ic_close']");
...
//		SUSHMA LIVETV MODULE
		...
		public static By objHighlightedChannelGuideToggle = By.xpath("//a[@class='noSelect active' and text()='Channel Guide']");
				
		public static By objOngoingLiveTvShowTitle = By.xpath("(//div[@class='programInner active'])[1]/child::*/child::div[@class='title']");
		
		public static By objFirstUpcomingShowcard = By.xpath("((//div[@class='programInner active'])[1]/parent::*/following-sibling::*)[1]");
...
//		SUSHMA
		...
		public static By objrelatedChannel(String Channel) {
			return By.xpath(
					"//div[@class='metaData']/child::*/child::span/child::span[contains(text(), '" + Channel + "')]");
		}
...
//		SUSHMA
		public static By objFilterLanguageChannelGuide =
				By.xpath("//button[contains(@class,'noSelect filterCompButton noSelect activeFilter iconInitialLoad-ic_filter')]");
	  	
	  	public static By objSelectedlang = By.xpath("//div[contains(@class,'selectedLanguage language noSelect')]");
	  	
	  	public static By objKannadaLang = By.xpath("//div[@class='languageContainer']/child::*/child::div[text()='Kannada']");
...
//	  	==================VINAY=================
		...
		public static By objFutureChannelInfo = By.xpath("(((//*[contains(@class,'programInner active')])[2]//parent::*)[1]//following-sibling::*)[2]");
		...
		public static By objShowTitle = By.xpath("(((//*[contains(@class,'programInner active')])[1]//parent::*)[1]//following-sibling::*)[2]//div[@class='title']");
		public static By objDescription = 
				By.xpath("(((//*[contains(@class,\"programInner active\")])[1]//parent::*)[1]//following-sibling::*)[2]//div[@class=\"timeInterval\"]");
		...
		public static By objShowName2 = 
				By.xpath("(//*[@title=\"Zee Keralam\"]//parent::*//parent::*//following-sibling::*//following-sibling::*)[1]");
		public static By objShowDesc =
				By.xpath("//div[@class='programDescription']");
		//Movie name
		public static By objMovieShow = 
				By.xpath("(//*[@title=\"Zee Picchar\"]//parent::*//parent::*//following-sibling::*//div)[2]");
		
		public static By objLiveTVMenu = By.xpath("//a[contains(text(),'Live TV')]");
		
		public static By objNothighlightedChannelGuideToggle = By.xpath("//*[@class='noSelect ' and text()='Channel Guide']");

		public static By objChannelGuideToggle = By.xpath("//a[contains(text(),'Channel Guide')]");

		public static By objLiveTVToggleInactive = By.xpath("//*[contains(@class,'toggleGroup')]//*[contains(@class,'noSelect')][contains(text(),'Live TV')]");
