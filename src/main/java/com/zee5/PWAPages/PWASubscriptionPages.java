...
public class PWASubscriptionPages {
	...
	public static By objSelectedPackDuration = By
			.xpath("//div[contains(@class, 'packDetails')]//*[@class='period']");
	...
	public static By objForgotPasswordLink = By.xpath("//span[contains(@class, 'forgotPassword') and contains(text(), 'Forgot Password')]");
	...
	public static By objadhocPopupArea = By.xpath(".//div[@class='element-shape closeLightboxButton editing adoric_element']");
...
//ZEE5 Logo
	//public static By objZEE5Logo = By.xpath("//div[contains(@class,'zeeLogo noSelect')]/img[contains(@title,'ZEE5 Logo')]");
...
//	=====================================================================================================
	...
	public static By objPaymentFailureCloseBtn = By.xpath("//div[@class='noSelect closePupup iconInitialLoad-ic_close']");
...
//	MANASA
	...
	public static By objPackCategoryTabSelected = By.xpath("//*[contains(@class,'active')]/*[contains(@class, 'noSelect')]");

	public static By objPackDescription = By.xpath("//*[@class='featureDesc']");

	public static By objSelectedSubscriptionPlanAmount = By.xpath("//*[contains(@class, 'noSelect subscriptionPlanCard active')]//*/*[contains(@class, 'currency')]");

	public static By objSelectedSubscriptionPlanDuration = By.xpath("//*[contains(@class, 'noSelect subscriptionPlanCard active')]/*/*[contains(@class, 'duration')]");

	public static By objHaveACode = By.xpath("//*[contains(@placeholder,'Have a Code?')]");

	public static By objApplyBtn = By.xpath("//*[contains(@class, 'noSelect applyPromo') and contains(text(), 'APPLY')]");
	...
	public static By objProceedBtnHighlighted = By.xpath("//*[contains(@class, 'noSelect buttonGradient')]/span[contains(text(),'PROCEED')]");

	public static By objEnterPasswordPopupTitle = By.xpath("//*[contains(@class, 'popupDesc bigTitle')]");

	public static By objProceedBtnDisabled = By.xpath("//*[contains(@class, 'popupBtn disableButton') and contains(text(), 'PROCEED')]");

	public static By objPasswordFieldHidden = By.xpath("//*[contains(@name, 'inputPassword') and contains(@type, 'password')]");

	public static By objProceedBtnEnabled = By.xpath("//*[contains(@class, 'popupBtn') and contains(text(), 'PROCEED')]");


	public static By objCreditAndDebitCardBtn = By.xpath("//*[@class='linearLayout sidebarItem_object ']//following-sibling::*//article[contains(text(),'Credit / Debit Card')]");
	public static By objWallets = By.xpath("//div[@class='linearLayout sidebarItemWrap sidebarItemWrap_wallet ']//article[contains(text(),'Wallets')]");
	public static By objPaytmWallet = By.xpath("//*[@class='linearLayout sidebarItem_object ']//following-sibling::*//article[contains(text(),'Paytm')]");
	public static By objPaymentPageProceedBtn = By.xpath("//button[contains(@class, 'noSelect buttonGradient ')]/span[contains(text(),'PROCEED')]");
	public static By objEnterCreditAndDebitCardDetails = By.xpath("//*[contains(@class,'editText') and contains(@placeholder,'Enter card number here')]");
	...
	public static By objAmazonPayProceedToPay = By.xpath("//div[@id='305']//article[contains(text(), 'Proceed to pay')]");
	public static By objMobikwikProceedToPay = By.xpath("//div[@id='328']//article[contains(text(), 'Proceed to pay')]");
