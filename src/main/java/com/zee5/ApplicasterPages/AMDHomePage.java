...
public class AMDHomePage {
	...
	public static By objCarouselDots = By.xpath(
			"(//*[@resource-id='com.graymatrix.did:id/cell_top_container'])[1]/parent::*/parent::*/parent::*/following-sibling::*");
	public static By objCarouselConetentCard = By
			.xpath("((//*[@resource-id='com.graymatrix.did:id/cell_top_container'])[1]/child::*)[1]");
	public static By objCarouselTitle1 = By.xpath(
			"(//*[@id='cell_top_container'])[1]/following-sibling::*[@resource-id='com.graymatrix.did:id/cell_center_container']/child::*[@index='0']");
	public static By objCarouselTitle2 = By.xpath(
			"(//*[@id='cell_top_container'])[1]/following-sibling::*[@resource-id='com.graymatrix.did:id/cell_center_container']/child::*[@enabled='true']");
	public static By objCarouselTitle3 = By.xpath(
			"(//*[@id='cell_top_container'])[1]/following-sibling::*[@resource-id='com.graymatrix.did:id/cell_center_container']/child::*[@onScreen='true']");
	...
	public static By objContentTitle(String title) {
		return By.xpath(
				"(//*[@resource-id='com.graymatrix.did:id/cell_top_container'])[1]/following-sibling::*[@resource-id='com.graymatrix.did:id/cell_center_container']/child::*[@text='"
						+ title + "']");
	}
	...
	public static By objBottomBarSelectedHomeTab = By.xpath(
			"//*[@resource-id='com.graymatrix.did:id/bottom_navigation_view']/child::*/child::*/child::*[@text='Home' and @selected='true']");
	...
	public static By objMoreMenuBtn = By.xpath("(//*[@id='navigationTitleTextView' and @text='More'])");

	public static By MoreMenuIcon = By.xpath("(//*[@id='navigationTitleTextView' and @text='More'])");
