...
public class AMDProfileScreen {
	...
	public static By objactivePackStatusUnderMyProfileSection = By.xpath("//*[@resource-id='com.graymatrix.did:id/txt_pack_status_label' and @text='Valid Till'] | //*[@text='Pack Status']");
