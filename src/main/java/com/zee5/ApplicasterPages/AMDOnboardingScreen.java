...
public class AMDOnboardingScreen {
	...
	public static By objBenefitsTextSection  = By.xpath("//*[@resource-id='com.graymatrix.did:id/benefitsTextRecyclerView']");
	...
	public static By objContentLanguageContainer = By.xpath("//*[@resource-id='com.graymatrix.did:id/content_lang_container']");
	public static By objContentLanguagePageTitle= By.xpath("//*[@resource-id='com.graymatrix.did:id/content_lang_screen_title']");
	...
	public static By objDotsIndicator(int index) {
		return By.xpath("//*[@id='dotsIndicator']//following-sibling::*[@class='android.widget.ImageView']["+index+"/]");
	}
