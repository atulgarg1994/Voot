...
public class AMDClubPack {
	...
	public static By objLoginCTAOnPlayer = By.xpath("//*[@resource-id='com.graymatrix.did:id/login_button']");
		...
		public static By objSubscribeinfoOnPlayer = By.xpath("//*[@id='errorViewText']");
		public static By objSubscribetoClubCTAOnPlayer = By.xpath("//*[@id='errorViewButton' and @text='Subscribe']");
		public static By objPlanlistonSubscribePopup = By.xpath("//*[@id='packsRecyclerView']");
		public static By objSubscribePopup = By.xpath("//*[@text='Subscribe']");
		public static By objClubPackPlan = By.xpath("//*[@id='background_container']");
		public static By objPack1InSubscribePopup = By.xpath("(//*[@class='android.widget.LinearLayout']//*[@id='holder_price'])[1]");
		public static By objPack2InSubscribePopup = By.xpath("(//*[@class='android.widget.LinearLayout']//*[@id='holder_price'])[2]");
		public static By objPack3InSubscribePopup = By.xpath("(//*[@class='android.widget.LinearLayout']//*[@id='holder_price'])[3]");
		public static By objSubscribetoPremiumCTAOnPlayer = By.xpath("//*[@text='Subscribe']");
		public static By objclubIconInContentListingScreen = By.xpath("(//*[@id='cell_center_container']//*[@class='android.widget.ImageView']//following-sibling::*[@class='android.widget.ImageView'])[1]");
		public static By objClubIconOnFirstCardOfTray = By.xpath("((//*[@class='androidx.recyclerview.widget.RecyclerView' and ./parent::*[@id='cell_center_container' and (./preceding-sibling::* | ./following-sibling::*)[./*[@text='Best of ZEE5 Originals in Kannada']]]]/*/*/*[@id='cell_center_container'])[1]/*[@class='android.widget.ImageView'])[2]");

		public static By objClubPlanTab = By.xpath("//*[@class='android.widget.TextView' and @text='Club']");
