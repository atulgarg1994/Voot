...
public class AMDSettingsScreen {
	...
	public static By objQualityOptionOnPlayer = By.xpath(
			"//*[@id='icon_quality_text'] | //*[@id='playerOptionTitle' and @text='Quality Auto'] | //*[@id='playerOptionTitle']");
	...
	public static By objoptionsInVideoQuality = By
			.xpath("(//*[@id='textView2'])[3] | (//*[@id='playerOptionTitle'])[2]");
