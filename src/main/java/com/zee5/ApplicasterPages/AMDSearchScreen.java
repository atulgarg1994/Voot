...
public class AMDSearchScreen {
	...
	public static By objSearchIcon = By.xpath("//*[@class='android.widget.ImageView' and ./parent::*[@class='android.support.v7.widget.LinearLayoutCompat']]");
	
	public static By objHomeOption = By.xpath("//*[@id='bb_bottom_bar_icon' and (./preceding-sibling::* | ./following-sibling::*)[@text='Home']]");

	public static By objUpcomingOption = By.xpath("//*[@id='bb_bottom_bar_icon' and (./preceding-sibling::* | ./following-sibling::*)[@text='Upcoming']]");

	public static By objDownloadsOption = By.xpath("//*[@id='bb_bottom_bar_icon' and (./preceding-sibling::* | ./following-sibling::*)[@text='Downloads']]");

	public static By objMoreOption = By.xpath("//*[@id='bb_bottom_bar_icon' and (./preceding-sibling::* | ./following-sibling::*)[@text='More']]");
	...
	public static By objRecentsearchOverlay = By.xpath("//*[@id='header_primary_text' and contains(text(),'Recent Searches')]");

	public static By objContentRecentSearch = By.xpath("//*[@id='item_primary_text' and contains(text(), ' \"+title+\" ')]");
	...
	public static By objTrendingSearchOverlay = By.xpath("//*[@id='header_primary_text' and contains(text(),'Trending Searches')]");

	public static By objTopSearchOverlay = By.xpath("//*[@id='header_primary_text' and contains(text(),'Top Searches')]");
	...
	public static By objFreeMovies = By.xpath("//*[@id='title']//ancestor::*[@class='android.support.v7.app.ActionBar$b']");
	...
	public static By objSearchResultPremiunm(String ResultName) {
		return By.xpath("//*[@resource-id='com.graymatrix.did:id/special_image_1']//following-sibling::*[@text='"+ResultName+"']");
	}
	...
	public static By objUpgradePopupDescription = By.xpath("//*[@resource-id='com.graymatrix.did:id/upgrade_subtitle']");
	...
	public static By objRevisedBillingInfo = By.xpath("//*[@resource-id='com.graymatrix.did:id/revised_billing_cycle_decription']");
	public static By objAccountInfo = By.xpath("//*[@resource-id='com.graymatrix.did:id/account_info_title']");
	public static By objYouWillBeChargedInfo = By.xpath("//*[@resource-id='com.graymatrix.did:id/payment_recurring_msg']");
	...
	public static By objTabs = By.xpath("//*[@id='searchResultsContent']//following-sibling::*[@id='tabLayout']//following-sibling::*");

	public static By objGetPremiumBelowThePlayer = By.xpath("//*[@resource-id='com.graymatrix.did:id/get_premium_button']");
	
	// Search icon
    public static By objSearchIcon2 = By.xpath("//*[@class='android.support.v7.widget.LinearLayoutCompat']//*[@class='android.widget.ImageView']");
    
    //Trending searches tray
    public static By objTrendingSearches = By.xpath("//*[@text='Recent Searches']/parent::*/parent::*/following-sibling::*[@class='android.widget.RelativeLayout']/child::*/child::*[@text='Trending Searches']");

    // title on Content card of Trending searches tray
    public static By objContentCardTitleOfTrendingSearchesTray = By.xpath("//*[@text='Trending Searches']/parent::*/parent::*/following-sibling::*/child::*/child::*/child::*/child::*/following-sibling::*[@resource-id='com.graymatrix.did:id/item_primary_text']");


    public static By objConsumptionScreenTitle = By.xpath("//*[@resource-id='com.graymatrix.did:id/item_primary_text']");
    
    public static By objTopSearches = By.xpath("//*[@text='Trending Searches']/parent::*/parent::*/following-sibling::*/child::*/child::*[@text='Top Searches']");
    
    public static By objContentCardTitleOfTopSearchesTray = By.xpath("//*[@text='Top Searches']/parent::*/parent::*/following-sibling::*/child::*/child::*[@resource-id='com.graymatrix.did:id/item_primary_text']");
    
	//public static By objSearchBox = By.xpath("//*[@resource-id='com.graymatrix.did:id/searchBar']");
