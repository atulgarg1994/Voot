...
//			boolean verifyHomePage = verifyElementExist(AMDHomePage.objHomeTab, "Home Screen");
	...
	public void ScreenViewFunctionality() throws Exception{
		...
		verifyElementPresentAndClick(AMDHomePage.objBottomUpcomingBtn, "Upcoming Button");
		waitTime(15000);
		verifyElementPresentAndClick(AMDHomePage.objBottomDownloadBtn, "Download Button");
		waitTime(15000);
		verifyElementPresentAndClick(AMDHomePage.objBottomMoreMenuBtn, "MoreMenu Button");
		waitTime(15000);
		verifyElementPresentAndClick(AMDHomePage.objBottomHomeBtn, "Home Button");
		waitTime(15000);
	}
