...
//			if ((verifyIsElementDisplayed(tvZee5SearchPage.objSearchedSpecificTumbnailcard(title, "Videos"), "Searched News"))) {
...
//		}
	...
	public void carouselValidation(String tab) throws Exception {
		...
		if (tab.equals("Videos")) {
			...
			waitTime(3000);
			Runtime.getRuntime().exec("adb shell input keyevent 23");
			if (verifyIsElementDisplayed(Zee5TvPlayerPage.objPlayPause, "Player pause")) {
				logger.info("User is navigated to consumption screen");
				extent.extentLoggerPass("play", "User is navigated to consumption screen");
			} else {
				logger.info("playback did not initiate");
		...
		if (tab.equals("News") == false) {
			if (tab.equals("Videos") == false) {
				...
				if (userType.equals("SubscribedUser")) {
					...
					waitTime(3000);
					Runtime.getRuntime().exec("adb shell input keyevent 23");
					if (verifyIsElementDisplayed(Zee5TvPlayerPage.objPlayPause, "Player pause button")) {
						logger.info("User is able to play premium content for premium user");
						extent.extentLoggerPass("play", "User is able to play premium content for premium user");
					} else {
						logger.info("playback did not initiate");
	...
	public void playerScenarios() throws Exception {
		...
		Runtime.getRuntime().exec("adb shell input keyevent 23");
		waitTime(2000);
		if (verifyIsElementDisplayed(Zee5TvPlayerPage.objForward10, "Player control")) {
			logger.info("Player is paused");
			extent.extentLoggerPass("Player", "Player is paused");
		} else {
			logger.info("Player is not paused");
			extent.extentLogger("Player", "Player is not paused");
		}
		if (verifyIsElementDisplayed(Zee5TvPlayerPage.objPlayerScreenTitle, "Player screen title")) {
			...
			String playerMetadata = TVgetText(Zee5TvPlayerPage.objPlayerScreenMetadata);
			logger.info("Consumption screen title : " + playertitle);
			logger.info("Consumption screen metadata : " + playerMetadata);
			extentLoggerPass("Consumpltion", "Consumption screen title : " + playertitle);
			extentLoggerPass("Consumpltion", "Consumption screen metadata : " + playerMetadata);
		...
		waitTime(2000);
		Runtime.getRuntime().exec("adb shell input keyevent 20");
		if (getDriver().findElement(Zee5TvPlayerPage.objPlayerSettings).getAttribute("focused") != null) {
		...
		waitTime(2000);
		Runtime.getRuntime().exec("adb shell input keyevent 19");
		if (getDriver().findElement(Zee5TvPlayerPage.objPlayerScreenVideoSettingoptions)
				.getAttribute("focused") != null) {
			System.out.println("IF");
			Runtime.getRuntime().exec("adb shell input keyevent 23");
		} else {
			System.out.println("ELSE");
		...
		waitTime(2000);
		Runtime.getRuntime().exec("adb shell input keyevent 19");
		if (getDriver().findElement(Zee5TvPlayerPage.objPlayerAudioLanguageOption).getAttribute("focused") != null) {
			System.out.println("IF");
			Runtime.getRuntime().exec("adb shell input keyevent 23");
		} else {
			System.out.println("ELSE");
		...
		waitTime(42000);
		if (verifyIsElementDisplayed(Zee5TvPlayerPage.objPlayPause, "Replay icon")) {
	...
	public void fetchCarouselScreenShot() throws Exception {
		HeaderChildNode("Carousel Validation ");
		if (userType.equals("Guest")) {
			waitTime(10000);
			if (verifyIsElementDisplayed(Zee5TvWelcomePage.objWelcomeSkipLink, "Skip Link")) {
				TVclick(Zee5TvWelcomePage.objWelcomeSkipLink, "Skip link");
	...
	public void continueWatching() throws Exception {
		...
		if (userType.equals("NonSubscribedUser") || userType.equals("SubscribedUser")) {
			...
			if (verifyIsElementDisplayed(Zee5TvSearchPage.objContinueWatchingProgressbar,
				...
				logger.info(
						"Continue watching tray and content progress bar is  not displayed for " + userType + " user");
				extent.extentLoggerFail("Tray",
						"Continue watching tray and content progress bar is  not displayed for " + userType + " user");
			}
		}
	...
	public void upnext() throws Exception {
		...
		HeaderChildNode("UpNext tray content navigation and focused validation");
		boolean upnext = getDriver().findElement(Zee5TvHomePage.objupnextTrayContent(1))
				.getAttribute("focused") != null;

		if (upnext) {
			logger.info("1st content of upnext rail is focused");
			extent.extentLoggerPass("focused", "1st content of upnext rail is focused");
		} else {
			logger.info("1st content of upnext rail is not focused");
			extent.extentLoggerPass("upnext", "1st content of upnext rail is not focused");
		}
		Runtime.getRuntime().exec("adb shell input keyevent 22");
		waitTime(3000);
		Runtime.getRuntime().exec("adb shell input keyevent 22");
		...
		boolean upnext2 = getDriver().findElement(Zee5TvHomePage.objupnextTrayContent(3))
				.getAttribute("focused") != null;

		if (upnext2) {
			logger.info("3rd content of upnext rail is focused and user can navigate to any content in upnext rail");
			extent.extentLoggerPass("focused",
					"3rd content of upnext rail is focused and user can navigate to any content in upnext rail");
		} else {
			logger.info("3rd content of upnext rail is not focused");
			extent.extentLoggerFail("upnext", "3rd content of upnext rail is not focused");
		}
		getDriver().navigate().back();
		waitTime(3000);
		getDriver().navigate().back();
	...
	public void chooseLanguagePopup() throws Exception {
	...
	public void profile() throws Exception {
		...
		waitTime(3000);
		if (!verifyIsElementDisplayed(Zee5TvWelcomePage.objParentalOption, "Parental option")) {
			logger.info("Parental option is not displayed in setting page");
			extent.extentLoggerPass("Parental", "Parental option is not displayed in setting pages");
		} else {
			logger.info("Parental option is displayed in setting page");
			extent.extentLoggerFail("Parental", "Parental option is displayed in setting page");
		}
		TVclick(Zee5TvWelcomePage.objVideoqualityOption, "Video quality option");
		waitTime(3000);
		TVclick(Zee5TvWelcomePage.objVideoqualityOption, "Video quality option");
	...
	public void deeplinking() throws Exception {
		...
		waitTime(2000);
		if (verifyIsElementDisplayed(Zee5TvPlayerPage.objForward10, "Player control")) {
			logger.info("User can play free content");
			extent.extentLoggerPass("Player", "User can play free content");
		} else {
			logger.info("Free content playback failed");
			extent.extentLoggerFail("Player", "Free content playback failed");
		}
		getDriver().navigate().back();
		waitTime(2000);
		getDriver().navigate().back();
	...
	public void talamoos() throws Exception {
		...
		for (int i = 0; i <= 15; i++) {
			waitTime(3000);
			if (verifyIsElementDisplayed(Zee5TvWelcomePage.objHomeTabTrending, "Trending tray")) {
		...
		for (int i = 0; i <= 15; i++) {
			waitTime(3000);
			if (verifyIsElementDisplayed(Zee5TvWelcomePage.objShowsTabTrending, "Trending tray")) {
		...
		for (int i = 0; i <= 15; i++) {
			waitTime(3000);
			if (verifyIsElementDisplayed(Zee5TvWelcomePage.objShowsTabTrending, "Trending tray")) {
				logger.info("Videos tab trending tray is displayed");
				extent.extentLoggerPass("Trending", "Videos tab trending tray is displayed");
				waitTime(2000);
				break;
			} else {
				Runtime.getRuntime().exec("adb shell input keyevent 20");
		...
		for (int i = 0; i <= 15; i++) {
			...
			if (verifyIsElementDisplayed(Zee5TvWelcomePage.objRecommendForYou, "Recommend for you tray")) {
				...
				extent.extentLoggerPass("Trending", "Movies tab Recommendation tray is displayed");
				waitTime(2000);
				break;
			} else {
				Runtime.getRuntime().exec("adb shell input keyevent 20");
...
//		waitTime(3000);
	...
	public void device() throws Exception {
		...
		if (userType.equals("Guest") || userType.equals("NonSubscribedUser")) {
			...
			authenticationLogin("NonSubscribedUser");
			mobilenumberLogin();
			facebooklogin();
		}
		if (userType.equals("SubscribedUser")) {
			deviceAuthentication();
			authenticationLogin("SubscribedUser");
			mobilenumberLogin();
			facebooklogin();
		}
	}
	...
	public void facebooklogin() throws Exception {
		...
		if (checkElementDisplayed(PWALandingPages.objWebProfileIcon, "Profile icon")) {
			...
			type(PWALoginPage.objFacebookLoginpasswordWeb, "IGS123@india", "Password Field");
