...
public class AndroidPWASanityScript {
	 ...
	 * @Test(priority = 1)
	 * 
	 * @Parameters({ "userType" }) // SHREENIDHI public void
	 * PWAMandatoryRegistration(String userType) throws Exception {
	 * Zee5PWASanityBusinessLogic.registerPopUpScenarios(userType); }
	 * 
	 * @Test(priority = 2) // SHREENIDHI
	 * 
	 * @Parameters({ "userType" }) public void PWAOnboardingScenarios(String
	 * userType) throws Exception { Zee5PWASanityBusinessLogic.reloadHome();
	 * Zee5PWASanityBusinessLogic.OnboardingScenario(userType); //from smoke }
	 * 
	 * @Test(priority = 3)
	 * 
	 * @Parameters({ "userType" }) // SHREENIDHI public void
	 * PWAMenuOrSettingScenarios(String userType) throws Exception {
	 * Zee5PWASanityBusinessLogic.reloadHome();
	 * Zee5PWASanityBusinessLogic.MenuOrSettingScenarios(userType); }
	 * 
	 * @Test(priority = 4) // BASAVARAJ
	 * 
	 * @Parameters({ "userType" }) public void PWAKalturaPlayability(String
	 * userType) throws Exception { Zee5PWASanityBusinessLogic.reloadHome();
	 * Zee5PWASanityBusinessLogic.Kaltura(userType); //smoke Vinay
	 * Zee5PWASanityBusinessLogic.playerValidations(userType);
	 * Zee5PWASanityBusinessLogic.UpnextRail(); }
	 * 
	 * @Test(priority = 5) // BASAVARAJ
	 * 
	 * @Parameters({"url", "userType", "devicePin",
	 * "consumptionsEpisode","consumptionsShow","consumptionsFreeContent",
	 * "consumptionsPremiumContent"}) public void PWAContentDetails(String url,
	 * String userType, String devicePin, String consumptionsEpisode,String
	 * consumptionsShow,String consumptionsFreeContent,String
	 * consumptionsPremiumContent)throws Exception {
	 * Zee5PWASanityBusinessLogic.reloadHome();
	 * Zee5PWASanityBusinessLogic.ContentDetails(userType);
	 * Zee5PWASanityBusinessLogic.checkDurationInLivetv();
	 * Zee5PWASanityBusinessLogic.checkDurationandProgressVideo(userType); //smoke
	 * Tanisha
	 * Zee5PWASanityBusinessLogic.verifyConsumptionsScreenTappingOnCard(userType,
	 * "Episode", consumptionsEpisode); // Episode //Mahira accuses Preeta of//
	 * trying to kill Mahesh //Neil gets// emotional while apologising to Jhende
	 * Zee5PWASanityBusinessLogic.verifyConsumptionsScreenTappingOnCard(userType,
	 * "Live TV", ""); // Live TV Card
	 * Zee5PWASanityBusinessLogic.verifyNoSubscriptionPopupForFreeContent(userType,
	 * consumptionsFreeContent);
	 * Zee5PWASanityBusinessLogic.verifySubscriptionPopupForPremiumContent(userType,
	 * consumptionsPremiumContent);
	 * Zee5PWASanityBusinessLogic.verifyCTAandMetaDataInDetailsAndConsumption(
	 * consumptionsShow); }
	 * 
	 * @Test(priority = 6)
	 * 
	 * @Parameters({ "userType" ,"url"}) // MANAS public void PWACarousel(String
	 * userType, String url) throws Exception {
	 * Zee5PWASanityBusinessLogic.reloadHome();
	 * //Zee5PWASanityBusinessLogic.ValidatingCarousalinalltabs(userType); //smoke
	 * landing // autorotating
	 ...
	 * Zee5PWASanityBusinessLogic.verifyPlayIconFunctionality("Home"); // premium
	 * icon functionality
	 * Zee5PWASanityBusinessLogic.verifyPremiumIconFunctionality("Home", userType);
	 * Zee5PWASanityBusinessLogic.verifyPremiumIconFunctionality("Premium",
	 * userType);
	 * Zee5PWASanityBusinessLogic.verifyPremiumIconFunctionality("Movies",
	 * userType);
	 * Zee5PWASanityBusinessLogic.verifyPremiumIconFunctionality("ZEE5 Originals",
	 * userType); // metadata String languageSmallText =
	 * Zee5PWASanityBusinessLogic.allSelectedLanguages();
	 * Zee5PWASanityBusinessLogic.verifyMetadataOnCarousel("ZEE5 Originals"
	 * ,"zeeoriginals", languageSmallText);
	 * Zee5PWASanityBusinessLogic.verifyMetadataOnCarousel("Play","play",
	 * languageSmallText);
	 * Zee5PWASanityBusinessLogic.verifyMetadataOnCarousel("Premium",
	 * "premiumcontents", languageSmallText);
	 * Zee5PWASanityBusinessLogic.verifyMetadataOnCarousel("Shows", "tvshows",
	 * languageSmallText);
	 * Zee5PWASanityBusinessLogic.verifyMetadataOnCarousel("Movies", "movies",
	 * languageSmallText);
	 * Zee5PWASanityBusinessLogic.verifyMetadataOnCarousel("Home", "home",
	 * languageSmallText); // <> Functionality
	 * Zee5PWASanityBusinessLogic.verifyLeftRightFunctionality("News", url);
	 * System.out.println(">>>> 4th method completed"); }
	 * 
	 * @Test(priority = 7)// VINAY
	 * 
	 * @Parameters({ "userType"}) public void PWALanguageModule(String UserType)
	 * throws Exception { Zee5PWASanityBusinessLogic.reloadHome();
	 * Zee5PWASanityBusinessLogic.LanguageModule(UserType); }
	 * 
	 * @Test(priority = 8) // SHREENIDHI
	 * 
	 * @Parameters({ "userType" }) public void PWAProfile(String userType) throws
	 * Exception { Zee5PWASanityBusinessLogic.reloadHome();
	 ...
	 * 
	 * @Parameters({ "userType" }) public void PWARecoTalamoosModule(String
	 * userType) throws Exception { Zee5PWASanityBusinessLogic.reloadHome();
	 * Zee5PWASanityBusinessLogic.verificationOfRecoTalamoos(userType); }
	 * 
	 * @Test(priority = 10) // BHAVANA
	 * 
	 * @Parameters({"userType"}) public void
	 * PWAStaticPagesInMenuAndFooterSection(String userType) throws Exception{
	 ...
	 * public void PWASearch(String userType,String searchKey,String url) throws
	 * Exception { Zee5PWASanityBusinessLogic.searchScreen(userType);
	 * Zee5PWASanityBusinessLogic.searchResultScreen(searchKey);
	 * Zee5PWASanityBusinessLogic.
	 * navigationToConsumptionScreenThroughTrendingSearches(); }
	 * 
	 * @Test(priority = 3)
	 * 
	 * @Parameters({"userType"}) public void PWALiveTV(String userType) throws
	 * Exception //SUSHMA LIVE TV {
	 * Zee5PWASanityBusinessLogic.LiveTvScreen(userType); //smoke
	 ...
	 * @Test(priority = 5)
	 * 
	 * @Parameters({ "userType" }) // MANASA public void
	 * PWASubscriptionPageValidation(String userType) throws Exception {
	 ...
	 * Zee5PWASanityBusinessLogic.validatingActiveAndExpiredCardsinMyTransactionPage
	 * (userType); }
	 * 
	 * 
	 * @Test(priority = 10)
	 * 
	 * @Parameters({ "userType" }) // SHREENIDHI public void
	 * PWANetworkInterruptions(String userType) throws Exception {
	 * Zee5PWASanityBusinessLogic.networkInterruptionScenarios(userType); }
	 * 
	 * @Test(priority = 11)
	 * 
	 * @Parameters({ "userType" }) // SATHISH public void
	 * PWASubscriptionPopUp(String userType) throws Exception {
	 * Zee5PWASanityBusinessLogic.
	 * zeePWAVerifySubscriptionPopupAfterTrailerPlaybackIsComplete(userType);
	 * Zee5PWASanityBusinessLogic.
	 * zeePWAVerifyNavigationToSubscriptionFlowFromSubscriptionPopupFullscreenPlayer
	 * (userType); //smoke
	 * Zee5PWASanityBusinessLogic.zeePWASubscriptionSuite(userType); }
	 * 
	 * @Test(priority = 13)
	 * 
	 * @Parameters({ "userType" }) // BHAVANA public void PWAExternalLinks(String
	 * userType) throws Exception {
	 * Zee5PWASanityBusinessLogic.LinksValidation(userType); }
	 * 
	 * @Test(priority = 15)
	 * 
	 * @Parameters({ "userType" }) // VINAY public void PWAUserActions(String
	 * userType) throws Exception {
	 * Zee5PWASanityBusinessLogic.UserActions(userType); }
	 * 
	 * 
	 * @Test(priority = 17) // BASAVARAJ public void PWAVIL() throws Exception {
	 * Zee5PWASanityBusinessLogic.verifyingVodafoneNativeApp(); }
	 * 
	 * @Test(priority = 20) // BASAVARAJ
	 * 
	 * @Parameters({ "userType" }) public void PWATimedAnchors(String userType)
	 * throws Exception {
