...
public class WebPWASanityScript {
	...
	//--------------------------SHREENIDHI Menu&Settings--------------------------
	  ...
	  //--------------------------SHREENIDHI Profile-------------------------- Last Module
		@Test(priority = 8) 
		@Parameters({ "userType" })
...
//	@Test(priority = 11)
	...
	public void musicPageValidation(String userType) throws Exception {
		...
		Zee5WEBPWASanityBusinessLogic.musicPageValidation("Music",userType,"Kalede Hode Naanu - Chambal | Sathish Ninasam | Sonu Gowda");
	}
...
//  	@Test(priority = 16)
  	...
  	public void SubscriptionPopup(String userType) throws Exception {
  		...
  		Zee5WEBPWASanityBusinessLogic.zeePWAVerifyNavigationToSubscriptionFlowFromSubscriptionPopupFullscreenPlayer(userType);
...
//  	@Test(priority = 20)
	...
	public void showsPage(String userType) throws Exception {
  	...
  	@Test(priority = 23)
  	@Parameters({ "browserType", "url", "userType", "devicePin", "consumptionsEpisode","consumptionsShow","consumptionsFreeContent","consumptionsPremiumContent"}) 
  	public void PWAContentDetails(String browser, String url, String userType, String devicePin, String consumptionsEpisode,String consumptionsShow,String consumptionsFreeContent,String consumptionsPremiumContent)throws Exception {
		...
		Zee5WEBPWASanityBusinessLogic.navigateToHome();
  		...
  		Zee5WEBPWASanityBusinessLogic.mandatoryRegistrationPopUp(userType);
  		Zee5WEBPWASanityBusinessLogic.verifyNoSubscriptionPopupForFreeContent(userType, consumptionsFreeContent);
