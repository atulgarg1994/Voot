...
public class AMDLoginScreen {
	...
	//Error Messages 
	public static By objErrorTxtMsg = By.xpath("//*[@id='textinput_error' and @text='Password must be a minimum of 6 characters']");
...
public static By objLoginPage = By.xpath("//*[@id='loginRegistrationContainer']");
	...
	public static By objMenu = By.xpath("//*[@id='bb_bottom_bar_icon' and (./preceding-sibling::* | ./following-sibling::*)[@text='More']]");
	
	public static By objMenuHindi = By.xpath("(//*[@id='bb_bottom_bar_item_container']/*/*[@id='bb_bottom_bar_icon'])[4]");
	
	public static By objDisplayLangHindi = By.xpath("//*[@text='हिन्दी']");
	
	public static By objLangEnglish = By.xpath("//*[@text='English']");
	public static By objLoginScreenTitle = By.xpath("//*[@resource-id='com.graymatrix.did:id/screen_title' and @text='Login']");
	public static By objLoginOrRegisterPageTitle= By.xpath("//*[@resource-id='com.graymatrix.did:id/screen_title' and @text='Login/Register']");
	
	//Forgot password screen title
	public static By objForgotPasswordScreenTitle = By.xpath("//*[@resource-id='com.graymatrix.did:id/screen_title' and @text='Forgot Password']");
	//Login with OTP link
	public static By objLoginWithOTPLink  = By.xpath("//*[@resource-id='com.graymatrix.did:id/tvLoginWithOTP']");
		
	public static By objOtpScreenTitle  = By.xpath("//*[@resource-id='com.graymatrix.did:id/screen_title' and @text='Verify Mobile']");
	...
	public static By objRegistrationScreenTitle = By.xpath("//*[@resource-id='com.graymatrix.did:id/screen_title' and @text='Register for FREE']");
	...
	public static By objContentLanguageScreenTitle = By.xpath("//*[@resource-id='com.graymatrix.did:id/screen_title' and @text='Content Language']");
...
public static By objGmailAccount = By.xpath("(//*[@id='account_name'])[1]");
	...
	public static By objTwitterEmail = By.xpath("//*[@class='android.widget.EditText' and @resource-id='username_or_email']");
