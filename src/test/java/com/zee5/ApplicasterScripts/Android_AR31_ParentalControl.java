...
public class Android_AR31_ParentalControl {
	...
	@Parameters({ "userType" })
	public void NewAge_U_RatingValidationBelowPlayer(String userType, String keyword) throws Exception {
		ZEE5ApplicasterBusinessLogic.NewAgeRatingValidationBelowPlayer(userType, keyword);//TC_30
	}
