...
//@Test(priority = 80) 
@Parameters({ "userType" })
public void authenticateChanges(String userType) throws Exception {
//	Zee5TvBusiness.authenticateChanges();
	Zee5TvBusiness.authenticateChangesThroughPremium();
//	Zee5TvBusiness.authenticateChangesThroughDeeplink();
}

@Test(priority = 80) 
@Parameters({ "userType" })
public void softblocker(String userType) throws Exception {
Zee5TvBusiness.blockerScreenSoftBlocker();
}
