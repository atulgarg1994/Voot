...
public class ApplicasterMixpanel_VideoWatchDuration {
...
//		System.out.println("Video Watch Duration event of Premium content when user completely watches the content");
...
//		System.out.println("Video Watch Duration event of Premium content when video is closed abruptly");
//		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
...
//	}
	...
	public void VideoWatchDurationEventofTrailerContentComplete(String userType, String keyword3) throws Exception {
		System.out.println("Video Watch Duration event of Trailer content when user completely watches the content");
		//Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
	...
	public void VideoWatchDurationEventofTrailerContentAbrupt(String userType, String keyword3) throws Exception {
		System.out.println("Video Watch Duration event of Trailer content when video is closed abruptly");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
	...
	public void VideoWatchDurationEventofCarouselContentComplete() throws Exception {
		System.out.println("Video Watch Duration event of Carousel content when user completely watches the content");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
	...
	public void VideoWatchDurationEventFromsearchpageComplete(String userType, String keyword4) throws Exception {
		System.out.println("Video Watch Duration event of Content from Search page when user completely watches the content");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
	...
	public void VideoWatchDurationEventFromsearchpageAbrupt(String userType, String keyword4) throws Exception {
		System.out.println("Video Watch Duration event of Content from Search page when video is closed abruptly");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
	...
	public void VideoWatchDurationEventFromMyWatchListComplete(String userType) throws Exception {
		System.out.println("Video Watch Duration event of Content from My WatchList page when user completely watches the content");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
	...
	public void VideoWatchDurationEventFromMyWatchListAbrupt(String userType) throws Exception {
		System.out.println("Video Watch Duration event of Content from My WatchList page when video is closed abruptly");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
	...
	public void VideoWatchDurationEventFromUpNextRailComplete(String userType, String keyword4) throws Exception {
		System.out.println("Video Watch Duration event of Content from Upnext Rail when user completely watches the content");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
	...
	public void VideoWatchDurationEventFromUpNextRailAbrupt(String userType, String keyword4) throws Exception {
		System.out.println("Video Watch Duration event of Content from Upnext Rail when video is closed abruptly");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
