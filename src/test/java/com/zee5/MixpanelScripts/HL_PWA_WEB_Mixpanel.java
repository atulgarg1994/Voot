...
//	@Test(priority = 1)
	...
	public void verifyAdWatchDurationEventForFreeContentForceExit(String userType, String subtitleTrackContent)
			throws Exception {
	...
	public void verifySubscriptionPageViewedEventByClickingGetPremiumCTAOnCarousel() throws Exception {
		...
		zee5PWABusinessLogic.relaunch();
		zee5PWABusinessLogic.verifySubscriptionPageViewedEventByClickingGetPremiumCTAOnCarousel();
	}
	...
	public void verifyVideoWatchDurationEventForCarouselContentComplete() throws Exception {
		...
		zee5PWABusinessLogic.relaunch();
		zee5PWABusinessLogic.verifyVideoWatchDurationEventForCarouselContentComplete();
	}
